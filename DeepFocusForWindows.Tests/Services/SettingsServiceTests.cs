...
public class SettingsServiceTests : IAsyncLifetime
{
    ...
    public async Task LoadAsync_WhenFileAbsent_ReturnsDefaults()
    {
        ...
        svc.Settings.IsDimmingEnabled.Should().BeFalse();
    ...
    public async Task SaveAndLoad_RoundTripsAllProperties()
    {
        ...
        svc.Settings.IsDimmingEnabled      = true;
        ...
        svc.Settings.AutoDimOnFocusSession = true;
        ...
        svc.Settings.IsDimmingEnabled.Should().BeTrue();
        ...
        svc.Settings.AutoDimOnFocusSession.Should().BeTrue();
    }
